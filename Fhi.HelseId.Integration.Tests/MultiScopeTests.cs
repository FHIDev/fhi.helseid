...
public class MultiScopeTests : IntegrationTest<Program>
{
    public MultiScopeTests() : base(new HelseIdApiKonfigurasjon
    {
        Authority = "https://helseid-sts.test.nhn.no/",
        ApiName = "fhi:helseid.testing.api",
        ApiScope = "fhi:helseid.testing.api/all,fhi:helseid.testing.api/person",
        AuthUse = true,
        UseHttps = true,
